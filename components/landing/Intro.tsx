...
export function Intro(): JSX.Element {
  return (
    <>
      <Notification message="Vi søker nye medlemmer! Søk da vel." url="/nyheter/2022/bli-styremedlem-2022/" />
      <Hero />
      <div className="py-16 lg:py-24 bg-gray-50 overflow-hidden">
        <div className="relative max-w-xl mx-auto px-4 sm:px-6 lg:px-8 lg:max-w-7xl">
          <div className="flex justify-center mb-16">
            <div className="p-6 max-w-sm bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
              <a href="https://echokarriere.no/nyheter/2022/fck-up-night/">
                <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">F*CK UP NIGHT</h5>
              </a>
              <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">
                Tror du alle voksene har livet på stell? Tror du ingen gjør feil på jobben? DA TAR DU HELT FEIL! Delta
                på F*ck Up Night 9. november
              </p>

              <a
                href="https://echokarriere.no/nyheter/2022/fck-up-night/"
